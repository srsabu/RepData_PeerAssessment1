...
library(lattice)
xyplot(averageStepsPerPeriodFilled$steps~averageStepsPerPeriodFilled$interval|averageStepsPerPeriodFilled$weekday, type="l", xlab="Interval", ylab="Number of Steps")
```
